...
struct Xoshiro256ssSpec {
  ...
  random_engine_ctor_fn ctor; ///< Constructor function to create an instance of Xoshiro256ss. [xoshiro256ss_ctor](xoshiro256ss_ctor)
  random_engine_next_fn next; ///< Function to generate the next random number in the engine. [xoshiro256ss_next](xoshiro256ss_next)
  random_engine_data_dtor_fn dtor; ///< Function to release the memory allocated for data by Xoshiro256ss. [xoshiro256ss_dtor](xoshiro256ss_dtor)
  xoshiro256ss_ctor_full_fn ctor_full; ///< Constructor function with a full 256-bit seed. [xoshiro256ss_ctor_full](xoshiro256ss_ctor_full)
  xoshiro256ss_ctor_seed_fn ctor_seed; ///< Constructor function with a single 64-bit seed. [xoshiro256ss_ctor_seed](xoshiro256ss_ctor_seed)
  xoshiro256ss_ctor_rd_fn ctor_rd; ///< Constructor function with a random device. [xoshiro256ss_ctor_rd](xoshiro256ss_ctor_rd)
};
